    ...
    <div class="footerContent">
        <div class="container">
            <div class="row">
                ...
                <!-- Contact Us -->
                <div class="col-6 col-md-3 col-lg-4 col-xl-4 col-xxl-4 mb-4">
                    <div class="footerCard">
                        <h5>Contact Us</h5>
                        <div class="contactChip">
                            ...
                            <span>
                                Vinayak Apartment, Ground Floor, Tidke Colony, Nashik, MH 422002
                            </span>
                        </div>
                        <div class="contactChip">
                            <h6>
                        ...
                        <div class="contactChip">
                            ...
                            <span>
                                <a href="mailto:info@elloraepc.com">info@elloraepc.com</a>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <!-- Navigation -->
                <div class="col-6 col-md-3 col-lg-3 col-xl-3 col-xxl-3 mb-4">
                    <div class="footerCard">
                        <h5>Navigation</h5>
                        <ul class="list-unstyled">
                            ...
                            <li><a href="#">Quality Endorsement</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="copyrightContent">
                    <p>&copy; <span id="year"></span> Ellora EPC. All Rights Reserved.</p>
